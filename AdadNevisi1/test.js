...
function generateQuestion(){
    ...
    if(isNumberToWord){
        ...
        const answers = [correctAnswer,numberToWords(Math.floor(randomNumber / 100)),numberToWords(Math.floor(randomNumber / 10)),numberToWords(Math.floor(randomNumber * 10))];
