...
function generateQuestion(){
    ...
    if(isNumberToWord){
        ...
        const answers = [correctAnswer,numberToWords(generateRandomNumber(99999)),numberToWords(generateRandomNumber(999999999999)),numberToWords(generateRandomNumber(999999999999))];
        //shuffle the array of answers randomly
